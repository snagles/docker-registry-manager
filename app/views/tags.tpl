     ...
     $('#delete-tags').on('submit', function(e){
        ...
        $(x).each(function(index) {
          ...
          $.ajax({
            ...
            statusCode: {
              404: function() {
                $("#delete-tags").append("<div class='alert alert-danger'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong>Failure!</strong> We were unable to delete "+tagName+" from the registry. For more details view the <a href='/settings'>logs</a>.</div>");
                $(".alert").alert();
                window.setTimeout(function() { $(".alert").alert('close'); }, 5000);
              },
              405: function() {
                $("#delete-tags").append("<div class='alert alert-danger'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong>4Failure (405)!</strong> We were unable to delete "+tagName+" from the registry. Registry reported that the operation is not supported. Make sure the delete option is enabled on the registry.</div>");
                $(".alert").alert();
                window.setTimeout(function() { $(".alert").alert('close'); }, 5000);
              },
              200: function() {
