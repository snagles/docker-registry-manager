          ...
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-12">
                ...
                <ul>
                  <li>docker pull {{.registryName}}/{{.repositoryName}}:{{.tagName}}</li>
                  <li>docker push {{.registryName}}/{{.repositoryName}}:{{.tagName}}</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div role="tabpanel" class="tab-pane" id="stages">
          <table id="datatable" class="table" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr data-tag-name="">
                <td>{{oneIndex $i}}</td>
                {{if not $history.EmptyLayer}} <td data-order=""> </i>{{$history.ManifestLayer.Digest}}</td>
